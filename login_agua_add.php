...
<body>
    <form action="login_agua_add.php" method="post">
    ...
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($contrasenha == $user['contrasenha']) { // Comparación directa porque la contraseña está almacenada como int
                ...
                $_SESSION['agua'] = $user['agua']; // Guarda el programa en la sesión
                header('Location: add_agua.php'); // Redirige al archivo que deseas
                exit;
            } else {
