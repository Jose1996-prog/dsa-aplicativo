...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['climatico'])) {
    header('Location: login_climatico_add.php');
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>CONTROL DE INDUCCIONES CAMBIO CLIMATICO DEPARTAMENTAL</title>
    <style>
        body {
...
<a href="logout_climatico_add.php" class="logout-button">Cerrar sesión</a>
<body>
    <center>
        <h2>CONTROL DE INDUCCION CAMBIO CLIMATICO DEPARTAMENTAL</h2>
    </center>
    <form action="crud_climatico.php" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="cargo_del_entrevistado" name="cargo_del_entrevistado" maxlength="100"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" id="objeticargo_funcionario_entidadvo_de_la_visita"
            ...
            <tr>
                <td colspan="3">
                    ...
                    <a href="../amb_1_index/Inicio_cambio_climatico.html">
                        <input type="button" value="Inicio">
                    </a>
                    <a href="read&delete_climatico.php">
