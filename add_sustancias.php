...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['sustancias'])) {
    header('Location: login_sustancias_add.php');
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>IVC SUSTANCIAS QUIMICAS DEPARTAMENTAL</title>
    <style>
...
<a href="logout_sustancias_add.php" class="logout-button">Cerrar sesión</a>
<body>
    <center>
        <h2>INSPECCION VIGILANCIA Y CONTROL DE SUSTANCIAS QUIMICAS DEPARTAMENTAL</h2>
    </center>
    <form action="crud_sustancias.php" method="post">
        <table>
            ...
            <tr>
                <td><label for="tecnico_saneamiento">Nombre del tecnico:</label></td>
                <td colspan="2"><input type="text" id="tecnico_saneamiento" name="tecnico_saneamiento" maxlength="100" required></td>
            </tr>
            ...
            <tr>
                <td><label for="categoria">Categoria del establecimiento:</label></td>
                <td colspan="2">
                    <select id="categoria" name="categoria">
                        <option value="Servicios">Servicios</option>
                        <option value="Talleres">Talleres</option>
                        <option value="Estacion de servicios">Estacion de servicios</option>
                        ...
                        <option value="Explotacion minera">Explotacion minera</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" id="correo" name="correo" maxlength="80">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="number" id="cedula" name="cedula" maxlength="50"></td>
            </tr>
            ...
            <tr>
                <td><label for="documentacion">¿El establecimiento cuenta con la
            ...
            <tr>
                <td><label for="cumplimiento_porcentaje">Porcentaje de cumplimiento:</label></td>
                <td colspan="2"><input type="number" step="0.01" id="cumplimiento_porcentaje" name="cumplimiento_porcentaje"
                        maxlength="5"></td>
            </tr>
            ...
            <tr>
                <td><label for="numero_visitas">Numero de visita:</label></td>
                <td colspan="2">
                    <select id="numero_visitas" name="numero_visitas">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <a href="read&delete_sustancias.php">
