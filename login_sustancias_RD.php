...
<body>
    <form action="login_sustancias_RD.php" method="post">
    <label for="usuario">Usuario:</label>
        ...
        <a href="../amb_1_index/Inicio_sustancias_quimicas.html">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $con->prepare('SELECT * FROM users_sustancias WHERE usuario = ?');
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($contrasenha == $user['contrasenha']) { // Comparación directa porque la contraseña está almacenada como int
                ...
                $_SESSION['sustancias'] = $user['sustancias'];
                header('Location: read&delete_sustancias.php'); // Redirige al archivo que deseas
                exit;
            } else {
