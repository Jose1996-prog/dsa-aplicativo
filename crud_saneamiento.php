...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['saneamiento'])) {
    header('Location: login_saneamiento_add.php');
    exit;
}
...
<a href="logout_saneamiento_add.php" class="logout-button">Cerrar sesión</a>
<body>
    <center>
        <h2>INSPECCION VIGILANCIA Y CONTROL DE SANEAMIENTO DEPARTAMENTAL</h2>
    </center>
    <form action="add_saneamiento.php" method="post">
        <table>
            ...
            <tr>
                ...
                <td colspan="2">
                    <select id="categoria_establecimiento" name="categoria_establecimiento">
                        ...
                        <option value="Carcelarios">Carcelarios</option>
                        <option value="Cuartelarios">Cuartelarios</option>
                        <option value="Vivienda permanente">Vivienda permanente</option>
                        <option value="Vivienda transitoria">Vivienda transitoria</option>
                        <option value="Puntos entrada">Puntos entrada</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td><label for="fecha_visita_actual">Fecha de la visita actual:</label></td>
                <td colspan="2"><input type="date" id="fecha_visita_actual" name="fecha_visita_actual" required>
                </td>
            </tr>
            ...
            <tr>
                <td><label for="identificacion_cedula">Identificacion cedula:</label></td>
                <td><input type="number" id="identificacion_cedula" name="identificacion_cedula" maxlength="20"></td>
            </tr>

            <tr>
                <td><label for="nit_del_establecimiento">¿Tiene NIT el establecimiento?</label></td>
                <td colspan="2">
                    <select id="nit_del_establecimiento" name="nit_del_establecimiento">
            ...
            <tr>
                <td><label for="digite_el_nit">Digite el NIT del establecimiento:</label></td>
                <td><input type="number" id="digite_el_nit" name="digite_el_nit" maxlength="100"></td>
            </tr>
            ...
            <tr>
                <td><label for="numero_de_visita">Numero de visita:</label></td>
                <td colspan="2">
                    <select id="numero_de_visita" name="numero_de_visita">
            ...
            <tr>
                <td><label for="establecimiento_cuenta_con_la_documentacion">¿El establecimiento cuenta con la
                        documentacion?</label></td>
                <td colspan="2">
                    <select id="establecimiento_cuenta_con_la_documentacion"
                        name="establecimiento_cuenta_con_la_documentacion">
                        <option value="Si">Si</option>
                        <option value="No">No</option>
                    </select>
                </td>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <a href="../amb_1_index/Inicio_saneamiento.html">
                        <input type="button" value="Inicio">
                    </a>
                    <a href="read&delete_saneamiento.php">
