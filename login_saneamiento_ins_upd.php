...
<body>
    <form action="login_saneamiento_ins_upd.php" method="post">
    <label for="usuario">Usuario:</label>
        ...
        <a href="../amb_1_index/Inicio_1_ambiental.html">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $con->prepare('SELECT * FROM users_saneamiento WHERE usuario = ?');
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($contrasenha == $user['contrasenha']) { // Comparación directa porque la contraseña está almacenada como int
                ...
                $_SESSION['saneamiento'] = $user['saneamiento'];
                header('Location: edit_saneamiento_ins_tec.php'); // Redirige al archivo que deseas
                exit;
            } else {
