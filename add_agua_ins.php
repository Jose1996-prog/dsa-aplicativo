...
if ($stmt->execute()) {
    echo "Datos insertados correctamente.<br><br><br>";
    echo '<a href="add_agua_ins.html" style="display:inline-block; padding:10px 15px; background-color:#4CAF50; color:white; text-decoration:none; border-radius:5px;">Regresar</a>';
    echo '<br><br>';
    // Enviar correo electrónico
    $to = $correo_electronico_propietario; // Dirección de correo del usuario
    $subject = "Confirmacion de Registro";
    
    // Crear el mensaje personalizado
    $message = "Señor(a) $nombres $primer_apellido $segundo_apellido,\n\n" .
               "Su establecimiento '$nombre_comercial_del_objeto' se ha registrado exitosamente en nuestra base de datos con el siguiente numero de registro: $numero_de_inscripcion.\n\n" .
               "Para poder verificar su registro, puede ingresar el siguiente link: [] y utilizar su numero de documento con el cual inscribio su establecimiento.\n\n" .
               "Muchas gracias por su atencion.";

    $headers = "From: dsainscripciones.online"; // Cambia esto por la dirección de correo del remitente

    if (mail($to, $subject, $message, $headers)) {
        echo " Correo enviado correctamente. <br>Recuerde revisar su en carpeta de correos no deseados, los mensajes de correo que se le enviaran son meramente informativos <br>";
    } else {
        echo "<br>";
