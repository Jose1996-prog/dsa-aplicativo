...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['climatico'])) {
    header('Location: login_climatico_RD.php');
    exit;
}
...
$opciones_orden = array(
    ...
    'correo_elec_entrevistado' => 'Correo elec entrevistado',
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM asistencia_cambio_climatico WHERE id = ?";
...
$sql = "SELECT * FROM asistencia_cambio_climatico ORDER BY $orden";
...
<a href="descargar_excel_climatico.php" class="btn_btn-primary">Descargar lista</a>
<a href="logout_climatico_RD.php" class="logout-button">Cerrar sesión</a>
<body>
</body>
</html>
