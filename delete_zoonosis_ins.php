...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['zoonosis'])) {
    header('Location: login_zoonosis_ins_RD.php');
    exit;
}
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM ins_zoonosis WHERE id = ?";
...
$sql = "SELECT * FROM ins_zoonosis ORDER BY $orden";
...
<a href="logout_zoonosis_ins_RD.php" class="logout-button">Cerrar sesión</a>
</body>
</html>
