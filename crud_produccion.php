...
switch ($accion) {
    case "Registrar":
        $sql = "INSERT INTO asistencia_produccion_limpia (
            fecha,
            encargado_visita,
            cargo,
            dimension,
        ...
        if ($stmt->execute()) {
            ...
            echo '<p>Puedes verificarlo presionando <a href="read&delete_produccion.php">aquí</a> y buscar o eliminar el registro.</p>';
            echo 'Presiona <a href="add_produccion.php">aquí</a> si deseas insertar un nuevo registro.';
            echo '<p>O presiona <a href="../amb_1_index/Inicio_produccion_limpia.html">aquí</a> si deseas ir menú principal del programa.</p>';
        } else {
