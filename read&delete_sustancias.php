...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['sustancias'])) {
    header('Location: login_sustancias_RD.php');
    exit;
}
...
$opciones_orden = array(
    'id' => 'Id',
    'tecnico_saneamiento' => 'Nombre del tecnico',
    ...
    'cumplimiento_porcentaje' => 'Cumplimiento porcentaje',
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM ivc_sustancias_quimicas WHERE id = ?";
...
$sql = "SELECT * FROM ivc_sustancias_quimicas ORDER BY $orden";
...
<a href="descargar_excel_sustancias.php" class="btn_btn-primary">Descargar Lista</a>
<a href="logout_sustancias_RD.php" class="logout-button">Cerrar sesión</a>
<body>
</body>
</html>