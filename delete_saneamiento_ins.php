...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['saneamiento'])) {
    header('Location: login_saneamiento_ins_RD.php');
    exit;
}
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM ins_saneamiento WHERE id = ?";
...
$sql = "SELECT * FROM ins_saneamiento ORDER BY $orden";
...
<a href="logout_saneamiento_ins_RD.php" class="logout-button">Cerrar sesión</a>
</body>
</html>
