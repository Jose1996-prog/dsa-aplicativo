...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['sustancias'])) {
    header('Location: login_sustancias_ins_RD.php');
    exit;
}
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM ins_sustancias_quimicas WHERE id = ?";
...
$sql = "SELECT * FROM ins_sustancias_quimicas ORDER BY $orden";
...
<body>
<a href="descargar_lista.php" class="btn_btn-primary">Descargar CSV</a>
<a href="logout_sustancias_ins_RD.php" class="logout-button">Cerrar sesión</a>
</body>
</html>
