...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['veo'])) {
    header('Location: login_veo_ins_RD.php');
    exit;
}
...
if (isset($_POST['eliminar_id'])) {
    ...
    $delete_sql = "DELETE FROM ins_veo WHERE id = ?";
...
$sql = "SELECT * FROM ins_veo ORDER BY $orden";
...
<a href="logout_veo_ins_RD.php" class="logout-button">Cerrar sesión</a>
</body>
</html>
